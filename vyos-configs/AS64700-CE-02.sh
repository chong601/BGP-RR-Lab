...
set system host-name AS64700-CE-02
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

# phase 2 - interface configuration
set interfaces dummy dum0 address 172.28.12.1/32
set interfaces ethernet eth0 address 172.28.2.43/31
set interfaces ethernet eth3 address 172.28.13.129/25
set interfaces bonding bond0 address 172.28.12.129/31
...
# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.12.1
...
set protocols bgp parameters router-id 172.28.12.1
...
# iBGP neighbors
set protocols bgp neighbor 172.28.12.0 remote-as 64700
set protocols bgp neighbor 172.28.12.0 update-source dum0
set protocols bgp neighbor 172.28.12.0 address-family ipv4-unicast

# eBGP neighbors
set protocols bgp neighbor 172.28.2.42 remote-as 64520
set protocols bgp neighbor 172.28.2.42 address-family ipv4-unicast
...
set protocols bgp address-family ipv4-unicast network 172.28.13.0/24
