...
set interfaces dummy dum0 address 172.28.0.10/32
...
set interfaces bonding bond0 address 192.168.8.128/31
...
# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.0.10
