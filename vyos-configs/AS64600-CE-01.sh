...
set system host-name AS64600-CE-01
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

# phase 2 - interface configuration
set interfaces dummy dum0 address 172.28.8.130/32
set interfaces ethernet eth0 address 172.28.2.33/31
set interfaces ethernet eth1 address 172.28.2.39/31
set interfaces ethernet eth2 address 172.28.8.2/26
set interfaces ethernet eth3 address 172.28.8.66/26
set interfaces bonding bond0 address 172.28.8.128/31
...
# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.8.130
...
set protocols bgp parameters router-id 172.28.8.130
...
set protocols bgp neighbor 172.28.2.32 remote-as 64520
set protocols bgp neighbor 172.28.2.32 address-family ipv4-unicast
set protocols bgp neighbor 172.28.2.38 remote-as 64520
set protocols bgp neighbor 172.28.2.38 address-family ipv4-unicast

set protocols bgp address-family ipv4-unicast network 172.28.8.0/24
set protocols static route 172.28.8.0/24 blackhole

set protocols bgp neighbor 172.28.8.131 remote-as 64600
set protocols bgp neighbor 172.28.8.131 update-source dum0
set protocols bgp neighbor 172.28.8.131 address-family ipv4-unicast
