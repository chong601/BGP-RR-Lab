...
set system host-name AS64520-PE-02
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

# phase 2 - interface configuration
set interfaces dummy dum0 address 172.28.0.7/32
set interfaces ethernet eth0 address 172.28.2.40/31
set interfaces ethernet eth4 address 172.28.2.19/31
set interfaces ethernet eth5 address 172.28.2.23/31

# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.0.7
...
set protocols bgp parameters router-id 172.28.0.7
...
set protocols bgp neighbor 172.28.2.41 remote-as 64700
set protocols bgp neighbor 172.28.2.41 address-family ipv4-unicast soft-reconfiguration inbound
