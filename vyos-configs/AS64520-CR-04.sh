...
set system host-name AS64520-CR-04
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

# phase 2 - interface configuration
set interfaces dummy dum0 address 172.28.0.5/32
set interfaces ethernet eth0 address 172.28.2.26/31
set interfaces ethernet eth1 address 172.28.2.30/31
set interfaces ethernet eth4 address 172.28.2.13/31
set interfaces ethernet eth5 address 172.28.2.15/31

# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.0.5
...
set protocols bgp parameters router-id 172.28.0.5
