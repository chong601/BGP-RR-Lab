...
set system host-name AS64520-PE-01
set system name-server 8.8.8.8
set system name-server 8.8.4.4
set service ssh

# phase 2 - interface configuration
set interfaces dummy dum0 address 172.28.0.6/32
set interfaces ethernet eth0 address 172.28.2.32/31
set interfaces ethernet eth1 address 172.28.2.34/31
set interfaces ethernet eth4 address 172.28.2.17/31
set interfaces ethernet eth5 address 172.28.2.21/31

# phase 3 - OSPF
set protocols ospf parameters router-id 172.28.0.6
...
set protocols bgp parameters router-id 172.28.0.6
...
set protocols bgp neighbor 172.28.2.33 remote-as 64600
set protocols bgp neighbor 172.28.2.33 address-family ipv4-unicast soft-reconfiguration inbound
set protocols bgp neighbor 172.28.2.35 remote-as 64600
set protocols bgp neighbor 172.28.2.35 address-family ipv4-unicast soft-reconfiguration inbound
